...
positions <- readRDS("Data/Fulmar/encounters/encounters_final_global.rds") 
globalpos <- readRDS("Data/Fulmar/Output_GLS_&_IRMA_locations_Fulmarus_glacialis_2020-04-30.rds") 
...
saveRDS(r.nb, paste0("Data/Fulmar/raster_global_birds",".rds")) 
