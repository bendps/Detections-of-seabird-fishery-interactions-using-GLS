...
positions <- readRDS("Data/Fisheries/2012-2016_filtered_loc.rds") #Change to the path of the output of script 8.
...
saveRDS(r.nb, paste0("Data/Fisheries/raster_global_fisheries.rds")) #Change to the path where the raster of fisheries will be saved #!!#
